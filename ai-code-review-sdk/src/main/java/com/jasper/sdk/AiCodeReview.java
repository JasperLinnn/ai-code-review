...
public class AiCodeReview {
    ...
    private static String codeReview(String code) throws Exception {
        ...
        ChatRequest.Message system = ChatRequest.Message.builder().role("system").content(new String(Files.readAllBytes(Paths.get(".docs/prompt/code-review-prompt.md")), StandardCharsets.UTF_8)).build();
